...
void DeviceHandler::tomTest(){
    qDebug() << "Message to HM successfully received :)";
}

void DeviceHandler::moveForword()
{
    QByteArray ba("N");
    QByteArray ba2("T");
    static const QString serviceUuid(QStringLiteral("0000FFE1-0000-1000-8000-00805F9B34FB"));
    m_service->writeCharacteristic(m_service->characteristic(QBluetoothUuid(serviceUuid)),ba);
    m_service->writeCharacteristic(m_service->characteristic(QBluetoothUuid(serviceUuid)),ba2);
...
void DeviceHandler::moveBackword()
{
    QByteArray ba("F");
    QByteArray ba2("T");
    static const QString serviceUuid(QStringLiteral("0000FFE1-0000-1000-8000-00805F9B34FB"));
...
{
    if (gatt.toString() == "{00001801-0000-1000-8000-00805f9b34fb}") {
...
//! [Filter HeartRate service 2]
    ...
    static const QString serviceUuid(QStringLiteral("0000FFE0-0000-1000-8000-00805F9B34FB"));
...
void DeviceHandler::serviceStateChanged(QLowEnergyService::ServiceState s)
{
    ...
    case QLowEnergyService::RemoteServiceDiscovered:
    {
        ...
        const QLowEnergyCharacteristic hrChar =
                ...
                m_service->characteristic(QBluetoothUuid(serviceUuid));
        if (!hrChar.isValid()) {
